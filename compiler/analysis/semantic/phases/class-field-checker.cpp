...
void class_field_checker::visit(ast::program& node) {
    for (auto& cls : node.classes) {
        cls->accept(*this);
    }
}

void class_field_checker::visit(ast::class_declaration& node) {
...
void class_field_checker::visit(ast::block& node) {}
void class_field_checker::visit(ast::parameter_declaration& node) {}
void class_field_checker::visit(ast::method_declaration& node) {}
void class_field_checker::visit(ast::constructor_declaration& node) {}
void class_field_checker::visit(ast::assignment_statement& node) {}
void class_field_checker::visit(ast::while_statement& node) {}
void class_field_checker::visit(ast::if_statement& node) {}
void class_field_checker::visit(ast::return_statement& node) {}

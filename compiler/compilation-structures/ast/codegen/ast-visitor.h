...
public:
    ...
    virtual void visit(field_declaration& node) = 0;
    ...
    virtual void visit(variable_assignment& node) = 0;
    virtual void visit(field_assignment& node) = 0;
    ...
    virtual void visit(method_call_expression& node) = 0;
    virtual void visit(constructor_call_expression& node) = 0;
